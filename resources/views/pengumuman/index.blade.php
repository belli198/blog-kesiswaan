...
<section class="section">
    <div class="container" style="max-width:850px">
        ...
        <a href="{{ route('pengumuman.show', $item->id) }}" style="text-decoration:none;color:inherit;display:block;margin-bottom:16px">
            <div class="announce-card fade-up" style="border-radius:20px;padding:30px;align-items:center;box-shadow:0 10px 30px rgba(0,0,0,0.03);position:relative;background:#fff;display:flex">
                <div class="announce-date" style="border-right:1px solid var(--surface-200);padding-right:30px;min-width:100px;text-align:center">
                    <div class="day" style="font-size:2.2rem;color:var(--primary-900);font-weight:700">{{ $item->created_at->format('d') }}</div>
                ...
                <div class="announce-content" style="padding-left:30px;flex:1">
                    ...
                    <h3 style="color:var(--primary-900);font-size:1.25rem;margin-bottom:10px">{{ $item->judul }}</h3>
                ...
                <div style="color:var(--primary-600);font-size:2rem;padding-left:20px">&rsaquo;</div>
            </div>
        </a>
        @empty
        <div style="text-align:center;padding:60px 20px;background:var(--surface-0);border-radius:24px;border:1px dashed var(--surface-200)">
            ...
            <h3 style="color:var(--primary-900);font-size:1.2rem;margin-bottom:10px">Belum ada pengumuman</h3>
